...
\newcommand{\studB}{{Lekovic, Morgan}}
\newcommand{\studC}{{Chen, Yang}}
\newcommand{\studD}{{Walker, Blake}}
% ADD ANOTHER LINE FOR A FIFTH MEMBER
%
% IMPORTANT - Then give your SIDs
\newcommand{\sidA}{{01234567}}
\newcommand{\sidB}{{520443860}}
\newcommand{\sidC}{{540065552}}
\newcommand{\sidD}{{550722375}}
% ADD ANOTHER LINE FOR A FIFTH MEMBER
...
\textbf{\large Github link: WILL ADD LATER}\\[0.75cm]
